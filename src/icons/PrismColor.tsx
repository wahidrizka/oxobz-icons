...
export const PrismColor = forwardRef<SVGSVGElement, IconProps>(
    ({ size = 16, color = 'currentColor', style, ...props }, ref) => (
        <svg
            ...
            {...props}
        >
            <path d="M9 7L12.5 2.5" stroke="var(--ds-red-700)" strokeWidth="1.5" strokeLinejoin="round">
                                                </path>
                                                <path d="M10.5 9.5L15.75 10.5" stroke="var(--ds-blue-600)"
                                                    strokeWidth="1.5" strokeLinejoin="round"></path>
                                                <path d="M10 8L15.75 6" stroke="var(--ds-teal-600)" strokeWidth="1.5" strokeLinejoin="round">
                                                </path>
