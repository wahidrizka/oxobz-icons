...
export const LogoNext = forwardRef<SVGSVGElement, IconProps>(
    ({ size = 16, color = 'currentColor', style, ...props }, ref) => (
        ...
        >
            <g clipPath="url(#clip0_53_108)">
                                                    <circle cx="8" cy="8" r="7.375" fill="black"
                                                        stroke="var(--ds-gray-1000)" strokeWidth="1.25"
                                                        strokeLinecap="round" strokeLinejoin="round"></circle>
                                                    <path d="M10.63 11V5" stroke="url(#paint0_linear_53_108_r_as_)"
                                                        strokeWidth="1.25" strokeMiterlimit="1.41421" strokeLinejoin="round"></path>
                                                    <path fillRule="evenodd" clipRule="evenodd"
                                                        ...
                                                        fill="url(#paint1_linear_53_108_r_as_)"></path>
                                                </g>
                                                <defs>
                                                    <linearGradient id="paint0_linear_53_108_r_as_" x1="11.13" y1="5"
                                                        x2="11.13" y2="11" gradientUnits="userSpaceOnUse">
                                                    ...
                                                    <linearGradient id="paint1_linear_53_108_r_as_" x1="9.9375"
                                                        y1="9.0625" x2="13.5574" y2="13.3992"
