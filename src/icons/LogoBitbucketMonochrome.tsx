...
export const LogoBitbucketMonochrome = forwardRef<SVGSVGElement, IconProps>(
    ({ size = 16, color, style, ...props }, ref) => (
        ...
        >
            <path fillRule="evenodd" clipRule="evenodd"
                                                    ...
                                                    fill="currentColor" style={{fill:"currentColor",fillOpacity:1}}>
                                                </path>
                                                <mask id="mask0_3908_2351" style={{maskType:"alpha"}}
                                                    maskUnits="userSpaceOnUse" x="1" y="5" width="13" height="10">
                                                    <path
                                                        ...
                                                        fill="url(#paint0_linear_3908_2351)" style={{}}></path>
                                                </mask>
                                                ...
                                                <defs>
                                                    <linearGradient id="paint0_linear_3908_2351" x1="0.112125"
                                                        y1="6.98861" x2="7.77447" y2="12.7502"
                                                        gradientUnits="userSpaceOnUse">
                                                        <stop offset="0.18" stopOpacity="0.4"
                                                            style={{stopColor:"black",stopOpacity:0.4}}></stop>
