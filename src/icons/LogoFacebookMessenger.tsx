...
export const LogoFacebookMessenger = forwardRef<SVGSVGElement, IconProps>(
        ...
        >
            <path
                                                ...
                                                <path
                                                    ...
                                                    fill="white"></path>
                                                <defs>
                                                    <radialGradient id="paint0_radial_4759_1851" cx="0" cy="0" r="1"
                                                        gradientUnits="userSpaceOnUse"
                                                        gradientTransform="translate(2.68 16) scale(17.6)">
                                                        <stop stopColor="#0099FF"
                                                            style={{stopColor:"color(display-p3 0.0000 0.6000 1.0000)",stopOpacity:1}}>
                                                        </stop>
                                                        <stop offset="0.6" stopColor="#A033FF"
                                                            style={{stopColor:"color(display-p3 0.6275 0.2000 1.0000)",stopOpacity:1}}>
                                                        </stop>
                                                        <stop offset="0.9" stopColor="#FF5280"
                                                            style={{stopColor:"color(display-p3 1.0000 0.3216 0.5020)",stopOpacity:1}}>
                                                        </stop>
                                                        <stop offset="1" stopColor="#FF7061"
                                                            style={{stopColor:"color(display-p3 1.0000 0.4392 0.3804)",stopOpacity:1}}>
                                                        </stop>
                                                    </radialGradient>
                                                </defs>
        </svg>
