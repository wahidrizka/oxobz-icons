...
export const LogoAmex = forwardRef<SVGSVGElement, IconProps>(
    ({ size = 16, color, style, ...props }, ref) => (
        ...
        >
            <g clipPath="url(#clip0_4898_1833)">
                                                    <rect width="16" height="16" rx="2" fill="#016FD0"
                                                        style={{fill:"color(display-p3 0.0039 0.4353 0.8157)",fillOpacity:1}}>
                                                    </rect>
                                                    <path d="M7.0999 2.5H15.9999L16 13.5H6.5V8.5H4.3999L7.0999 2.5Z"
                                                        fill="white" style={{fill:"white",fillOpacity:1}}></path>
