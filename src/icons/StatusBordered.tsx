...
export const StatusBordered = forwardRef<SVGSVGElement, IconProps>(
    ({ size = 16, color, style, ...props }, ref) => (
        <svg
            ...
            {...props}
        >
            <g clipPath="url(#clip0_6799_10812)">
                                                    <path
                                                        d="M8 5.03125C9.6396 5.03125 10.9688 6.3604 10.9688 8C10.9688 9.6396 9.6396 10.9688 8 10.9688C6.3604 10.9688 5.03125 9.6396 5.03125 8C5.03125 6.3604 6.3604 5.03125 8 5.03125Z"
