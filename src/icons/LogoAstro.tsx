...
export const LogoAstro = forwardRef<SVGSVGElement, IconProps>(
    ({ size = 16, color, style, ...props }, ref) => (
        ...
        >
            <path
                                                    ...
                                                    fill="url(#paint0_linear_1427_1479)" style={{}}></path>
                                                <path
                                                ...
                                                <defs>
                                                    <linearGradient id="paint0_linear_1427_1479" x1="4.68506" y1="16"
                                                        x2="12.3496" y2="12.2743" gradientUnits="userSpaceOnUse">
                                                        <stop stopColor="#D83333"
                                                            style={{stopColor:"color(display-p3 0.8471 0.2000 0.2000)",stopOpacity:1}}>
                                                        </stop>
                                                        <stop offset="1" stopColor="#F041FF"
                                                            style={{stopColor:"color(display-p3 0.9412 0.2549 1.0000)",stopOpacity:1}}>
                                                        </stop>
                                                    </linearGradient>
                                                </defs>
        </svg>
